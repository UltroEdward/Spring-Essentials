	...
	public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		...
		for (Field field : fields) {
			...
			if (annotations != null) {
				...
				System.out.println(String.format("BeanPostProcessor.postProcessBeforeInitialization {%s}: Reading annotation in [%s] from field [%s] - [%s]",
			...
			if (upperCase != null) {
				...
				if (value != null) {
					System.out.println(String.format(
							"BeanPostProcessor.postProcessAfterInitialization: {%s}: Using @UpperCase to change field [%s] with value [%s] in [%s]",
